# -*- coding: utf-8 -*-
## {{{ http://code.activestate.com/recipes/576393/ (r1)
...
## end of http://code.activestate.com/recipes/576393/ }}}
 


# Approximation of complex gamma function, using Lanczos approximation
# From:
